...
$(function () {
    ...
    <c:forEach items="${graphValues}" var="item">{
    			...
    			point:{
                	events:{
                		click:function(){
                            ...
                            chart.xAxis[0].removePlotLine('vt');
    		...
    		buttons: {
    			...
    			'myButton': {
    				...
    				onclick: function (chart) {
    					...
    					this.xAxis[0].removePlotLine('vt');
                ...
                $("#last").click(function(event){
        	    	...
        	    	alert('select VT');
                		...
                		{
             	  	var hv = $('#power').val();
                	window.location.href ="result?id=${dataSetnumber}&value="+hv.trim();
             	  		}
...
<section id="wrapperss" style="width:100%;margin:80px auto 50px;position:relative;">
  ...
  <input type="hidden" name="hiddenVCO2" id="hiddenVCO2" value=""/>
  <input type="hidden" name="hiddenVO2" id="hiddenVO2" value=""/>
  <input type="hidden" name="hiddenVE" id="hiddenVE" value=""/>
  <input type="hidden" name="hiddenValue1" id="hiddenValue1" value="${dataSetnumber}"/>
  <center>
  <div style="float: left;"><b style="font-family:Helvetica Neue">DataSet-${dataSetnumber}</b></div><b style="font-size: 24px" style="font-family:Helvetica Neue">Wasserman-9Plot Graphs</b><div style="float: right;"> <b style="font-family:Helvetica Neue"> ${dataSetnumber *5}% of 100%</b> <progress value="${dataSetnumber *5}" max="100" id="progBar" >
    ...
    <table>
        <tr>
        <c:if test="${dataSetnumber != 1}">
        	<td><a href="#Previous?id=${dataSetnumber -1}&lastPage=${dataSetnumber}&valuePage=" class="info_link2">Previous</a></td>
        	<td><c:out value="<<"/></td>
        </c:if>
            <c:forEach begin="1" end="20" var="i">
                <c:choose>
                    <c:when test="${dataSetnumber eq i}">
                        <td><a  class="info_link" href="#" >${dataSetnumber}</a></td>
                    </c:when>
                    <c:otherwise>
                    <td>${i}</td>
                    </c:otherwise>
            ...
            <c:if test="${dataSetnumber lt 20 }">
            <td><c:out value=">>"/></td>
        	<td><a href="#WassermanGraphs?id=${dataSetnumber +1}&value=" class="info_link">Next</a></td>
        </c:if>
        </tr>
    </table>
     <br/>
    ...
    <table>
        ...
        <c:if test="${dataSetnumber != 1}">
            ...
            <c:if test="${dataSetnumber lt 20 }">
            <td><c:out value=">>"/></td>
        	<td><a href="#WassermanGraphs?id=${dataSetnumber +1}&value=" class="info_link" style="font-family:Helvetica Neue">Next</a></td>
        </c:if>
        </tr>
    </table>
    </center> 
